 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.LazyPrimMST.java
 *  Execution:    java com.dzhou.corejava.algs4.LazyPrimMST filename.txt
 *  Dependencies: com.dzhou.corejava.algs4.EdgeWeightedGraph.java com.dzhou.corejava.algs4.Edge.java com.dzhou.corejava.algs4.Queue.java
 *                com.dzhou.corejava.algs4.MinPQ.java com.dzhou.corejava.algs4.UF.java In.java StdOut.java
 ...
 *  algorithm.
 *
 *  %  java com.dzhou.corejava.algs4.LazyPrimMST tinyEWG.txt
 *  0-7 0.16000
 *  1-7 0.19000
 *  0-2 0.26000
 *  2-3 0.17000
 ...
 *  1.81000
 *
 *  % java com.dzhou.corejava.algs4.LazyPrimMST mediumEWG.txt
 *  0-225   0.02383
 *  49-225  0.03314
 *  44-49   0.02107
 *  44-204  0.01774
 ...
 *  10.46351
 *
 *  % java com.dzhou.corejava.algs4.LazyPrimMST largeEWG.txt
 *  ...
 *  647.66307
 *
 *************************************************************************/
...
/**
 *  The <tt>com.dzhou.corejava.algs4.LazyPrimMST</tt> class represents a data type for computing a
...
public class LazyPrimMST {
            ...
            for (Edge f : G.edges()) {
                ...
                if (!uf.connected(x, y)) {
                    if (f.weight() < e.weight()) {
                        System.err.println("com.dzhou.corejava.algs4.Edge " + f + " violates cut optimality conditions");
                        return false;
                    }
                }
            }
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.LazyPrimMST</tt> data type.
     */
