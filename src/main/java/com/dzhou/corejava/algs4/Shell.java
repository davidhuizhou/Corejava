 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.Shell.java
 *  Execution:    java com.dzhou.corejava.algs4.Shell < input.txt
 ...
 *
 *  % java com.dzhou.corejava.algs4.Shell < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *    
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *  
 *  % java com.dzhou.corejava.algs4.Shell < words3.txt
...
/**
 *  The <tt>com.dzhou.corejava.algs4.Shell</tt> class provides static methods for sorting an
 *  array using Shellsort with com.dzhou.corejava.algs4.Knuth's increment sequence (1, 4, 13, 40, ...).
 *  <p>
