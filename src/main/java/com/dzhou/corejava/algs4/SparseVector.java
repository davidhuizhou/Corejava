...
/*************************************************************************
 *  Compilation:  javac com.dzhou.corejava.algs4.SparseVector.java
 *  Execution:    java com.dzhou.corejava.algs4.SparseVector
 *  
...
public class SparseVector {
    ...
    public double dot(SparseVector that) {
        if (this.N != that.N) throw new IllegalArgumentException("com.dzhou.corejava.algs4.Vector lengths disagree");
        double sum = 0.0;
