 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.IndexMaxPQ.java
 *  Execution:    java com.dzhou.corejava.algs4.IndexMaxPQ
 *
...
/**
 *  The <tt>com.dzhou.corejava.algs4.IndexMaxPQ</tt> class represents an indexed priority queue of generic keys.
...
public class IndexMaxPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
   ...
   /**************************************************************
    * com.dzhou.corejava.algs4.Heap helper functions
    **************************************************************/
    ...
    **********************************************************************/
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.IndexMaxPQ</tt> data type.
     */
