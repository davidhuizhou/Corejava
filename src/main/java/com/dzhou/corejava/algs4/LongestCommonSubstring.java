...
/*************************************************************************
 *  Compilation:  javac com.dzhou.corejava.algs4.LongestCommonSubstring.java
 *  Execution:    java  com.dzhou.corejava.algs4.LongestCommonSubstring file1.txt file2.txt
 *  Dependencies: com.dzhou.corejava.algs4.SuffixArray.java StdOut.java In.java
 *  
 ...
 *  (and make sure com.dzhou.corejava.algs4.SuffixArray.java doesn't choose the same one).
 * 
 *  % java com.dzhou.corejava.algs4.LongestCommonSubstring tale.txt mobydick.txt
