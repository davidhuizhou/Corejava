 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.SET.java
 *  Execution:    java com.dzhou.corejava.algs4.SET
 *  
 *  Set implementation using Java's TreeSet library.
 *  Does not allow duplicates.
 *
 *  % java com.dzhou.corejava.algs4.SET
 *  128.112.136.11
 *  208.216.181.15
 *  null
 *
...
/**
 *  The <tt>com.dzhou.corejava.algs4.SET</tt> class represents an ordered set of comparable keys.
...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.SET</tt> data type.
     */
