...
/*************************************************************************
 *  Compilation:  javac com.dzhou.corejava.algs4.KWIK.java
 *  Execution:    java com.dzhou.corejava.algs4.KWIK file.txt
 *  Dependencies: StdIn.java StdOut.java In.java com.dzhou.corejava.algs4.SuffixArray.java
 *  Data files:   http://algs4.cs.princeton.edu/63suffix/tale.txt
 *
 *  %  java com.dzhou.corejava.algs4.KWIK tale.txt 15
 *  majesty
