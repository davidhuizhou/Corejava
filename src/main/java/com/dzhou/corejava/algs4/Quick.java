 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.Quick.java
 *  Execution:    java com.dzhou.corejava.algs4.Quick < input.txt
 ...
 *
 *  % java com.dzhou.corejava.algs4.Quick < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *       
 *  % java com.dzhou.corejava.algs4.Quick < words3.txt
