 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.EdgeWeightedDigraph.java
 *  Execution:    java com.dzhou.corejava.algs4.EdgeWeightedDigraph V E
 *  Dependencies: com.dzhou.corejava.algs4.Bag.java com.dzhou.corejava.algs4.DirectedEdge.java
 *
...
/**
 *  The <tt>com.dzhou.corejava.algs4.EdgeWeightedDigraph</tt> class represents a edge-weighted
 ...
 *  is a vertex-indexed array of @link{com.dzhou.corejava.algs4.Bag} objects.
...
public class EdgeWeightedDigraph {
    ...
    public EdgeWeightedDigraph(int V) {
        if (V < 0) throw new IllegalArgumentException("Number of vertices in a com.dzhou.corejava.algs4.Digraph must be nonnegative");
        this.V = V;
        this.E = 0;
    ...
    public EdgeWeightedDigraph(int V, int E) {
        this(V);
        if (E < 0) throw new IllegalArgumentException("Number of edges in a com.dzhou.corejava.algs4.Digraph must be nonnegative");
        for (int i = 0; i < E; i++) {
     ...
     * <tt>for (com.dzhou.corejava.algs4.DirectedEdge e : G.edges())</tt>.
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.EdgeWeightedDigraph</tt> data type.
     */
