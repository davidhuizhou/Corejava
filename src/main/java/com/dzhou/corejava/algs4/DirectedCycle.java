 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.DirectedCycle.java
 *  Execution:    java com.dzhou.corejava.algs4.DirectedCycle < input.txt
 *  Dependencies: com.dzhou.corejava.algs4.Digraph.java com.dzhou.corejava.algs4.Stack.java StdOut.java In.java
 ...
 *  Runs in O(E + V) time.
 *
 *  % java com.dzhou.corejava.algs4.DirectedCycle tinyDG.txt
 *  com.dzhou.corejava.algs4.Cycle: 3 5 4 3
 *
 *  %  java com.dzhou.corejava.algs4.DirectedCycle tinyDAG.txt
 *  No cycle
 *
 *************************************************************************/
...
/**
 *  The <tt>com.dzhou.corejava.algs4.DirectedCycle</tt> class represents a data type for
...
public class DirectedCycle {
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.DirectedCycle</tt> data type.
     */
    public static void main(String[] args) {
        ...
        if (finder.hasCycle()) {
            StdOut.print("com.dzhou.corejava.algs4.Cycle: ");
