 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.BinarySearch.java
 *  Execution:    java com.dzhou.corejava.algs4.BinarySearch whitelist.txt < input.txt
 *  Data files:   http://algs4.cs.princeton.edu/11model/tinyW.txt
 *                http://algs4.cs.princeton.edu/11model/tinyT.txt
 *                http://algs4.cs.princeton.edu/11model/largeW.txt
 *                http://algs4.cs.princeton.edu/11model/largeT.txt
 *
 *  % java com.dzhou.corejava.algs4.BinarySearch tinyW.txt < tinyT.txt
 *  50
 *  99
 *  13
 *
 *  % java com.dzhou.corejava.algs4.BinarySearch largeW.txt < largeT.txt | more
 *  499569
 *  984875
 *  295754
 *  207807
...
/**
 *  The <tt>com.dzhou.corejava.algs4.BinarySearch</tt> class provides a static method for binary
