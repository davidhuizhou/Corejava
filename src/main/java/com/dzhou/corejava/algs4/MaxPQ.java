 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.MaxPQ.java
 *  Execution:    java com.dzhou.corejava.algs4.MaxPQ < input.txt
 *  
 *  Generic max priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order,
 *  but the generic Key type must still be Comparable.
 *
 *  % java com.dzhou.corejava.algs4.MaxPQ < tinyPQ.txt
 *  Q X P (6 left on pq)
 *
...
/**
 *  The <tt>com.dzhou.corejava.algs4.MaxPQ</tt> class represents a priority queue of generic keys.
...
public class MaxPQ<Key> implements Iterable<Key> {
    ...
    **********************************************************************/
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.MaxPQ</tt> data type.
     */
