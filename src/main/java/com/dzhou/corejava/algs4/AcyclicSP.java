 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.AcyclicSP.java
 *  Execution:    java com.dzhou.corejava.algs4.AcyclicSP V E
 *  Dependencies: com.dzhou.corejava.algs4.EdgeWeightedDigraph.java com.dzhou.corejava.algs4.DirectedEdge.java com.dzhou.corejava.algs4.Topological.java
 *  Data files:   http://algs4.cs.princeton.edu/44sp/tinyEWDAG.txt
 *
 *  Computes shortest paths in an edge-weighted acyclic digraph.
 *
 *  % java com.dzhou.corejava.algs4.AcyclicSP tinyEWDAG.txt 5
...
/**
 *  The <tt>com.dzhou.corejava.algs4.AcyclicSP</tt> class represents a data type for solving the
...
public class AcyclicSP {
    ...
    public AcyclicSP(EdgeWeightedDigraph G, int s) {
        ...
        if (!topological.hasOrder())
            throw new IllegalArgumentException("com.dzhou.corejava.algs4.Digraph is not acyclic.");
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.AcyclicSP</tt> data type.
     */
