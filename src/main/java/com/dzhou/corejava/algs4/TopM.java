 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.TopM.java
 *  Execution:    java com.dzhou.corejava.algs4.TopM M < input.txt
 *  Dependencies: com.dzhou.corejava.algs4.MinPQ.java com.dzhou.corejava.algs4.Transaction.java StdIn.java StdOut.java
 ...
 *  each line contains a String and a long value, this com.dzhou.corejava.algs4.MinPQ client
 *  prints the M lines whose numbers are the highest.
 * 
 *  % java com.dzhou.corejava.algs4.TopM 5 < tinyBatch.txt
...
/**
 *  The <tt>com.dzhou.corejava.algs4.TopM</tt> class provides a client that reads a sequence of
