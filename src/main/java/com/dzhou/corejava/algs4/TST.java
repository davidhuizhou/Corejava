...
/*************************************************************************
 *  Compilation:  javac com.dzhou.corejava.algs4.TST.java
 *  Execution:    java com.dzhou.corejava.algs4.TST < words.txt
 *  Dependencies: StdIn.java
 *
 *  Symbol table with string keys, implemented using a ternary search
 *  trie (com.dzhou.corejava.algs4.TST).
 *
 *
 *  % java com.dzhou.corejava.algs4.TST < shellsST.txt
 *  by 4
 *  sea 6
 *  sells 1
 *  she 0
 ...
 *
 *  % java com.dzhou.corejava.algs4.TST
...
public class TST<Value> {
    private int N;       // size
    private Node root;   // root of com.dzhou.corejava.algs4.TST
   ...
   /**************************************************************
    * Find and return longest prefix of s in com.dzhou.corejava.algs4.TST
    **************************************************************/
