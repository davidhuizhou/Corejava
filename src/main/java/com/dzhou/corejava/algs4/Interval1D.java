 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.Interval1D.java
 *  Execution:    java com.dzhou.corejava.algs4.Interval1D
 *  
...
/**
 *  The <tt>com.dzhou.corejava.algs4.Interval1D</tt> class represents a one-dimensional closed interval.
 *  Intervals are immutable: their values cannot be changed after they are created.
 *  The class <code>com.dzhou.corejava.algs4.Interval1D</code> includes methods for checking whether
...
public class Interval1D {
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.Interval1D</tt> data type.
     */
