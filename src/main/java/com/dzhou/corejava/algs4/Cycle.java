 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.Cycle.java
 *  Dependencies: com.dzhou.corejava.algs4.Graph.java com.dzhou.corejava.algs4.Stack.java
 *
 *  Identifies a cycle.
 *  Runs in O(E + V) time.
 *
 *  % java com.dzhou.corejava.algs4.Cycle tinyG.txt
 *  3 4 5 3 
 * 
 *  % java com.dzhou.corejava.algs4.Cycle mediumG.txt
 *  15 0 225 15 
 * 
 *  % java com.dzhou.corejava.algs4.Cycle largeG.txt
...
/**
 *  The <tt>com.dzhou.corejava.algs4.Cycle</tt> class represents a data type for
...
public class Cycle {
   ...
   public Iterable<Integer> cycle() {
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.Cycle</tt> data type.
     */
    public static void main(String[] args) {
        ...
        if (finder.hasCycle()) {
            ...
            StdOut.println("com.dzhou.corejava.algs4.Graph is acyclic");
        }
    }
