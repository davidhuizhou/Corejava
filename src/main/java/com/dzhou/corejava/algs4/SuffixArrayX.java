 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.SuffixArrayX.java
 *  Execution:    java com.dzhou.corejava.algs4.SuffixArrayX < input.txt
 *  
 *  A data type that computes the suffix array of a string using 3-way
 *  radix quicksort.
 *
 *  % java com.dzhou.corejava.algs4.SuffixArrayX < abra.txt
...
/**
 *  The <tt>com.dzhou.corejava.algs4.SuffixArrayX</tt> class represents a suffix array of a string of
 *  length <em>N</em>.
