 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.EdgeWeightedGraph.java
 *  Execution:    java com.dzhou.corejava.algs4.EdgeWeightedGraph filename.txt
 *  Dependencies: com.dzhou.corejava.algs4.Bag.java com.dzhou.corejava.algs4.Edge.java In.java StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/43mst/tinyEWG.txt
 *
 *  An edge-weighted undirected graph, implemented using adjacency lists.
 *  Parallel edges and self-loops are permitted.
 *
 *  % java com.dzhou.corejava.algs4.EdgeWeightedGraph tinyEWG.txt
 *  8 16
...
/**
 *  The <tt>com.dzhou.corejava.algs4.EdgeWeightedGraph</tt> class represents an edge-weighted
...
public class EdgeWeightedGraph {
     ...
     * <tt>for (com.dzhou.corejava.algs4.Edge e : G.edges())</tt>.
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.EdgeWeightedGraph</tt> data type.
     */
