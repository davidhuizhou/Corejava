 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.FlowNetwork.java
 *  Execution:    java com.dzhou.corejava.algs4.FlowNetwork V E
 *  Dependencies: com.dzhou.corejava.algs4.Bag.java com.dzhou.corejava.algs4.FlowEdge.java
 *
...
/**
 *  The <tt>com.dzhou.corejava.algs4.FlowNetwork</tt> class represents a capacitated network
...
public class FlowNetwork {
    ...
    public FlowNetwork(int V) {
        if (V < 0) throw new IllegalArgumentException("Number of vertices in a com.dzhou.corejava.algs4.Graph must be nonnegative");
        this.V = V;
        this.E = 0;
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.FlowNetwork</tt> data type.
     */
