 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.MergeX.java
 *  Execution:    java com.dzhou.corejava.algs4.MergeX < input.txt
 ...
 *
 *  % java com.dzhou.corejava.algs4.MergeX < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *    
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *  
 *  % java com.dzhou.corejava.algs4.MergeX < words3.txt
...
/**
 *  The <tt>com.dzhou.corejava.algs4.MergeX</tt> class provides static methods for sorting an
