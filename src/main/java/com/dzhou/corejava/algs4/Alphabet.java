...
/*************************************************************************
 *  Compilation:  javac com.dzhou.corejava.algs4.Alphabet.java
 *  Execution:    java  com.dzhou.corejava.algs4.Alphabet
 *  
...
public class Alphabet {
    ...
    // Create a new com.dzhou.corejava.algs4.Alphabet from sequence of characters in string.
    ...
    // Create a new com.dzhou.corejava.algs4.Alphabet of Unicode chars 0 to R-1
    ...
    // Create a new com.dzhou.corejava.algs4.Alphabet of Unicode chars 0 to 255 (extended ASCII)
    public Alphabet() {
        this(256);
    }
    ...
    public char toChar(int index) {
        if (index < 0 || index >= R) {
            throw new IndexOutOfBoundsException("com.dzhou.corejava.algs4.Alphabet index out of bounds");
        }
