 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.MinPQ.java
 *  Execution:    java com.dzhou.corejava.algs4.MinPQ < input.txt
 *  
 *  Generic min priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order.
 *
 *  % java com.dzhou.corejava.algs4.MinPQ < tinyPQ.txt
 *  E A E (6 left on pq)
 *
...
/**
 *  The <tt>com.dzhou.corejava.algs4.MinPQ</tt> class represents a priority queue of generic keys.
...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    **********************************************************************/
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.MinPQ</tt> data type.
     */
