 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.FlowEdge.java
 *  Execution:    java com.dzhou.corejava.algs4.FlowEdge
 *
...
/**
 *  The <tt>com.dzhou.corejava.algs4.FlowEdge</tt> class represents a capacitated edge with a
...
public class FlowEdge {
    ...
    public FlowEdge(int v, int w, double capacity) {
        ...
        if (!(capacity >= 0.0)) throw new IllegalArgumentException("com.dzhou.corejava.algs4.Edge capacity must be nonnegaitve");
        this.v         = v;
        this.w         = w;  
   ...
   /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.FlowEdge</tt> data type.
     */
