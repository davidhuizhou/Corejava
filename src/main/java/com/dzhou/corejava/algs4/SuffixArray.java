 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.SuffixArray.java
 *  Execution:  java com.dzhou.corejava.algs4.SuffixArray < input.txt
 *
 *  A data type that computes the suffix array of a string.
 *
 *   % java com.dzhou.corejava.algs4.SuffixArray < abra.txt
 ...
 *   11   2   2  11  "RACADABRA!"
 *
 *  See com.dzhou.corejava.algs4.SuffixArrayX.java for an optimized version that uses 3-way
...
/**
 *  The <tt>com.dzhou.corejava.algs4.SuffixArray</tt> class represents a suffix array of a string of
 *  length <em>N</em>.
...
public class SuffixArray {
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.SuffixArray</tt> data type.
     */
