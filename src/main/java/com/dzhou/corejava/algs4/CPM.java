 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.CPM.java
 *  Execution:    java com.dzhou.corejava.algs4.CPM < input.txt
 *  Dependencies: com.dzhou.corejava.algs4.EdgeWeightedDigraph.java AcyclicDigraphLP.java StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/44sp/jobsPC.txt
 *
 *  Critical path method.
 *
 *  % java com.dzhou.corejava.algs4.CPM < jobsPC.txt
 *   job   start  finish
 *  --------------------
 *     0     0.0    41.0
 *     1    41.0    92.0
...
/**
 *  The <tt>com.dzhou.corejava.algs4.CPM</tt> class provides a client that solves the
