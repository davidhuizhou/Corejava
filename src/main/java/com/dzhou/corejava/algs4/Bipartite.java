 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.Bipartite.java
 *  Dependencies: com.dzhou.corejava.algs4.Graph.java
 *
...
/**
 *  The <tt>com.dzhou.corejava.algs4.Bipartite</tt> class represents a data type for
...
public class Bipartite {
    ...
    public boolean color(int v) {
        if (!isBipartite)
            throw new UnsupportedOperationException("com.dzhou.corejava.algs4.Graph is not bipartite");
        return color[v];
    }
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.Bipartite</tt> data type.
     */
    public static void main(String[] args) {
        ...
        if (b.isBipartite()) {
            StdOut.println("com.dzhou.corejava.algs4.Graph is bipartite");
            for (int v = 0; v < G.V(); v++) {
                StdOut.println(v + ": " + b.color(v));
            }
        }
        else {
            StdOut.print("com.dzhou.corejava.algs4.Graph has an odd-length cycle: ");
