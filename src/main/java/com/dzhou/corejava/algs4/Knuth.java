 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.Knuth.java
 *  Execution:    java com.dzhou.corejava.algs4.Knuth < list.txt
 ...
 *  The com.dzhou.corejava.algs4.Knuth (or Fisher-Yates) shuffling algorithm guarantees
 ...
 *
 *  % java com.dzhou.corejava.algs4.Knuth < cards.txt
 *  6H
 *  9C
 *  8H
 *  7C
...
/**
 *  The <tt>com.dzhou.corejava.algs4.Knuth</tt> class provides a client for reading in a
 *  sequence of strings and <em>shuffling</em> them using the com.dzhou.corejava.algs4.Knuth (or Fisher-Yates)
...
public class Knuth { 
   ...
   private Knuth() { }
     ...
     * @see com.dzhou.lib.algorithms.StdRandom
     */
