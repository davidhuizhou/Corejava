 ...
 *  Compilation:  javac com.dzhou.lib.algorithms.BinaryIn.java
 *  Execution:    java com.dzhou.lib.algorithms.BinaryIn input output
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java com.dzhou.lib.algorithms.BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 *************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>com.dzhou.lib.algorithms.BinaryIn</tt> with calls
