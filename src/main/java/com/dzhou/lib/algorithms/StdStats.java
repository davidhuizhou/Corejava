...
/*************************************************************************
 *  Compilation:  javac com.dzhou.lib.algorithms.StdStats.java
 *  Execution:    java com.dzhou.lib.algorithms.StdStats < input.txt
 *
 ...
 *  3.0 1.0 2.0 5.0 4.0
 *
 *  % java com.dzhou.lib.algorithms.StdStats < tiny.txt
 *         min   1.000
 *        mean   3.000
 *         max   5.000
 *     std dev   1.581
