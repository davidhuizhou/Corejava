 ...
 * Test client for com.dzhou.lib.algorithms.StdIn and In.
 **/
...
public class StdInTest {
    ...
    public static void test(String input, Object[][] steps, boolean useStdIn) {
        ...
        if (useStdIn) {
            ...
            try { //call com.dzhou.lib.algorithms.StdIn.resync();
    ...
    public static void main(String[] args) {
        ...
        if (testStdIn) 
            ...
            StdOut.println("Note: com.dzhou.lib.algorithms.StdIn.resync is private, only In will be tested.");
