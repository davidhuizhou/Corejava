 ...
 *  Compilation:  javac com.dzhou.lib.algorithms.BinaryStdIn.java
 *  Execution:    java com.dzhou.lib.algorithms.BinaryStdIn < input > output
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java com.dzhou.lib.algorithms.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>com.dzhou.lib.algorithms.BinaryStdIn</tt> with calls
 *  to <tt>com.dzhou.lib.algorithms.StdIn</tt> or <tt>System.in</tt>;
   ...
   /**
    ...
    public static void close() {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Could not close com.dzhou.lib.algorithms.BinaryStdIn");
        }
    }
