 ...
 *  Compilation:  javac com.dzhou.lib.algorithms.Out.java
 *  Execution:    java com.dzhou.lib.algorithms.Out
 *
...
public class Out {
   ...
   /**
     * Create an com.dzhou.lib.algorithms.Out object using an OutputStream.
     */
   ...
   /**
     * Create an com.dzhou.lib.algorithms.Out object using standard output.
     */
    public Out() { this(System.out); }

   /**
     * Create an com.dzhou.lib.algorithms.Out object using a Socket.
     */
   ...
   /**
     * Create an com.dzhou.lib.algorithms.Out object using a file specified by the given name.
     */
    public Out(String s) {
        try {
